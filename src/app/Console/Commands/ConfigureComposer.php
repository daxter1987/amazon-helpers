...
namespace daxter1987\AmazonS3Helper\Commands;
...
class ConfigureComposer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'dax:s3:install';
    ...
    public function handle()
    {
        ...
        if(empty($project_composer_array['autoload']['psr-4']["daxter1987\\AmazonS3Helper\\"])){
            $project_composer_array['autoload']['psr-4']["daxter1987\\AmazonS3Helper\\"] = "vendor/daxter1987/AmazonS3Helper/src/Http/Models/";
        }
        ...
        echo "\033[33mComposer file updated, run composer dump-autoload!\033[0m\n";
    }
}
